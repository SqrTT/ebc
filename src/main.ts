...
// initial map
let cumulativeLevel1 = [["#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#"], ["#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#", "#"], ["#", "#", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", "#", "#", "#", "#"], ["#", "#", " ", "╔", "═", "═", "═", "═", "┐", " ", " ", " ", " ", " ", " ", "╔", "═", "═", "═", "═", "═", "═", "═", "═", "═", "┐", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", "#", "#", "#", "#"], [" ", " ", " ", "║", ".", ".", ".", "˅", "│", " ", " ", " ", " ", " ", " ", "║", "˃", ".", ".", ".", ".", ".", ".", ".", ".", "│", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", "#", "#", "#", "#"], [" ", " ", " ", "║", ".", ".", ".", "O", "│", " ", " ", " ", " ", " ", " ", "║", ".", ".", ".", ".", "Z", ".", ".", ".", ".", "│", " ", "╔", "═", "═", "═", "═", "═", "═", "┐", " ", "#", "#", "#", "#"], [" ", " ", " ", "║", ".", ".", ".", ".", "│", " ", " ", " ", " ", " ", " ", "║", ".", ".", ".", ".", ".", ".", ".", ".", ".", "│", " ", "║", "˃", ".", "O", ".", ".", "O", "│", " ", "#", "#", "#", "#"], [" ", " ", " ", "║", ".", ".", "S", ".", "│", " ", " ", "╔", "═", "═", "═", "╝", "˃", ".", ".", ".", ".", ".", ".", ".", "O", "│", " ", "║", ".", ".", ".", ".", ".", ".", "│", " ", " ", " ", "#", "#"], [" ", " ", " ", "║", "˃", ".", ".", ".", "╚", "═", "═", "╝", ".", ".", ".", "$", ".", ".", "O", ".", ".", "S", ".", ".", ".", "│", " ", "║", "O", ".", "S", ".", "O", "˂", "│", " ", " ", " ", "#", "#"], [" ", " ", " ", "║", ".", ".", ".", ".", ".", "S", ".", ".", ".", "┌", "─", "╗", ".", ".", ".", ".", ".", ".", ".", "O", "O", "│", " ", "║", "O", ".", ".", ".", ".", ".", "│", " ", " ", " ", "#", "#"], [" ", " ", " ", "║", ".", ".", ".", ".", "┌", "─", "─", "─", "─", "┘", " ", "║", ".", "O", ".", ".", ".", ".", ".", ".", ".", "│", " ", "║", ".", ".", "┌", "─", "─", "─", "┘", " ", " ", " ", "#", "#"], [" ", " ", " ", "║", ".", ".", ".", "O", "│", " ", " ", " ", " ", " ", " ", "║", ".", ".", ".", ".", ".", ".", ".", ".", ".", "╚", "═", "╝", ".", ".", "│", " ", " ", " ", " ", " ", " ", " ", "#", "#"], [" ", " ", " ", "└", "╗", ".", "┌", "─", "┘", " ", "╔", "═", "═", "═", "═", "╝", ".", ".", ".", "O", "O", ".", ".", ".", ".", ".", ".", ".", ".", ".", "│", " ", " ", " ", " ", " ", " ", " ", "#", "#"], [" ", " ", " ", " ", "║", ".", "│", " ", " ", " ", "║", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "│", " ", " ", " ", " ", " ", " ", " ", "#", "#"], [" ", " ", " ", " ", "║", ".", "│", " ", " ", " ", "║", ".", "S", ".", "┌", "─", "╗", ".", ".", ".", "┌", "─", "─", "─", "─", "─", "╗", ".", ".", ".", "╚", "═", "┐", " ", " ", " ", " ", " ", "#", "#"], [" ", " ", " ", " ", "║", ".", "│", " ", " ", " ", "║", ".", ".", ".", "│", " ", "║", ".", ".", ".", "│", " ", " ", " ", " ", " ", "║", "O", ".", ".", ".", ".", "│", " ", " ", " ", " ", " ", "#", "#"], [" ", " ", " ", " ", "║", ".", "│", " ", " ", " ", "└", "─", "─", "─", "┘", " ", "║", ".", ".", ".", "│", " ", " ", " ", " ", " ", "║", "$", ".", ".", ".", "˂", "│", " ", " ", " ", " ", " ", "#", "#"], [" ", " ", " ", "╔", "╝", ".", "╚", "═", "┐", " ", " ", " ", " ", " ", " ", " ", "║", ".", ".", ".", "│", " ", " ", "╔", "═", "═", "╝", ".", "Z", ".", ".", ".", "│", " ", " ", " ", " ", " ", "#", "#"], [" ", " ", " ", "║", ".", ".", ".", ".", "│", " ", " ", "╔", "═", "═", "═", "═", "╝", ".", ".", ".", "│", " ", " ", "║", ".", ".", ".", ".", ".", "O", ".", ".", "│", " ", " ", " ", " ", " ", "#", "#"], [" ", " ", " ", "║", ".", ".", ".", ".", "│", " ", " ", "║", ".", ".", ".", ".", ".", ".", ".", ".", "╚", "═", "═", "╝", "$", ".", ".", ".", ".", "$", "S", ".", "│", " ", " ", " ", " ", " ", "#", "#"], [" ", " ", " ", "║", "O", ".", "Z", ".", "╚", "═", "═", "╝", "O", ".", "S", ".", "O", ".", "$", ".", ".", ".", ".", "$", ".", "┌", "─", "─", "─", "─", "╗", ".", "│", " ", " ", " ", " ", " ", "#", "#"], [" ", " ", " ", "║", ".", ".", "O", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "O", "┌", "─", "─", "─", "─", "┘", " ", " ", " ", " ", "║", "$", "╚", "═", "═", "═", "┐", " ", "#", "#"], [" ", " ", " ", "║", "˄", ".", ".", ".", "┌", "─", "─", "╗", ".", "O", ".", ".", "$", ".", ".", ".", "│", " ", " ", " ", " ", " ", " ", " ", "╔", "═", "╝", ".", ".", ".", "$", "S", "│", " ", "#", "#"], [" ", " ", " ", "║", ".", ".", ".", ".", "│", " ", " ", "║", ".", ".", ".", ".", ".", ".", ".", "▲", "│", " ", " ", "╔", "═", "═", "═", "═", "╝", "►", ".", ".", "$", ".", ".", ".", "│", " ", "#", "#"], [" ", " ", " ", "└", "─", "╗", ".", "┌", "┘", " ", " ", "║", "˃", ".", ".", "O", ".", ".", ".", "O", "│", " ", " ", "║", "˃", "Z", ".", ".", ".", ".", ".", ".", ".", "Z", ".", ".", "│", " ", "#", "#"], [" ", " ", " ", " ", " ", "║", ".", "│", " ", " ", " ", "└", "─", "─", "─", "╗", ".", "┌", "─", "─", "┘", " ", " ", "└", "─", "─", "─", "─", "╗", "˃", ".", "Z", ".", ".", ".", ".", "│", " ", "#", "#"], [" ", "╔", "═", "═", "═", "╝", ".", "╚", "═", "┐", " ", " ", " ", " ", " ", "║", ".", "│", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", "└", "─", "─", "─", "╗", ".", ".", "O", "│", " ", "#", "#"], [" ", "║", ".", ".", "O", ".", ".", ".", "˂", "│", " ", " ", "╔", "═", "═", "╝", ".", "╚", "═", "═", "═", "═", "═", "═", "═", "═", "┐", " ", " ", " ", " ", " ", "║", ".", "O", ".", "│", " ", "#", "#"], [" ", "║", ".", ".", "Z", ".", "O", ".", ".", "│", " ", " ", "║", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "│", " ", " ", " ", " ", " ", "║", "O", ".", ".", "│", " ", "#", "#"], [" ", "║", ".", "┌", "─", "─", "─", "─", "─", "┘", " ", " ", "║", ".", "┌", "─", "─", "─", "╗", ".", ".", ".", ".", ".", ".", ".", "╚", "═", "═", "═", "═", "═", "╝", ".", "┌", "─", "┘", " ", "#", "#"], [" ", "║", ".", "│", " ", " ", " ", " ", " ", " ", " ", " ", "║", ".", "│", " ", " ", " ", "║", ".", ".", ".", ".", "O", ".", ".", ".", ".", "Z", ".", ".", "Z", ".", ".", "│", " ", " ", " ", "#", "#"], [" ", "║", ".", "│", " ", "╔", "═", "═", "═", "═", "═", "═", "╝", ".", "╚", "┐", " ", " ", "║", "┌", "─", "╗", ".", ".", ".", ".", "┌", "─", "─", "─", "╗", ".", ".", "┌", "┘", " ", " ", " ", "#", "#"], [" ", "║", ".", "│", " ", "║", ".", "$", ".", "Z", ".", "˂", ".", ".", "$", "╚", "═", "═", "╝", "│", " ", "└", "─", "╗", ".", "┌", "┘", " ", " ", " ", "║", ".", ".", "│", " ", " ", " ", " ", "#", "#"], [" ", "║", ".", "│", " ", "║", ".", ".", "O", ".", ".", ".", ".", "O", ".", ".", ".", ".", ".", "│", " ", " ", " ", "║", ".", "│", " ", " ", " ", " ", "║", ".", ".", "╚", "═", "═", "┐", " ", "#", "#"], [" ", "║", ".", "╚", "═", "╝", ".", ".", "O", ".", ".", "E", ".", ".", ".", "┌", "─", "╗", ".", "╚", "═", "═", "═", "╝", ".", "╚", "═", "═", "┐", " ", "║", ".", ".", ".", ".", ".", "│", " ", "#", "#"], [" ", "║", ".", ".", ".", ".", ".", ".", "O", ".", "Z", "O", ".", ".", ".", "│", " ", "║", "$", ".", ".", "˃", ".", ".", ".", "O", ".", ".", "│", " ", "║", ".", ".", ".", ".", "˂", "│", " ", "#", "#"], [" ", "║", ".", "┌", "─", "─", "─", "╗", ".", ".", ".", ".", ".", ".", ".", "│", " ", "║", ".", ".", ".", ".", ".", ".", "E", ".", ".", ".", "│", " ", "║", "$", ".", "E", ".", ".", "│", " ", "#", "#"], [" ", "║", "˄", "│", " ", " ", " ", "║", ".", ".", ".", ".", ".", ".", "˂", "│", " ", "└", "─", "─", "╗", ".", ".", "O", ".", ".", "O", ".", "│", " ", "║", "˃", ".", ".", ".", ".", "│", " ", "#", "#"], [" ", "└", "─", "┘", " ", " ", " ", "║", ".", "Z", ".", ".", ".", ".", ".", "│", " ", " ", " ", " ", "└", "─", "─", "─", "─", "─", "─", "─", "┘", " ", "║", ".", "Z", ".", ".", ".", "│", " ", "#", "#"], [" ", " ", " ", " ", " ", " ", " ", "└", "─", "─", "─", "─", "─", "─", "─", "┘", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", "└", "─", "─", "─", "─", "─", "┘", " ", "#", "#"]];
...
var processBoard = function (boardString: string) {
    ...
    if (pressed[38]) {
        ...
        const [answer, distances] = currentGame.tick(boardJson, false);
